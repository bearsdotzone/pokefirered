...
static const u8 sFameCheckerTrainerGenders_Unused[] = {
    [FAMECHECKER_OAK]      = MASCULINE,
    [FAMECHECKER_DAISY]    = FEMININE,
    [FAMECHECKER_BROCK]    = MASCULINE,
    [FAMECHECKER_MISTY]    = FEMININE,
    [FAMECHECKER_LTSURGE]  = MASCULINE,
    [FAMECHECKER_ERIKA]    = FEMININE,
    [FAMECHECKER_KOGA]     = MASCULINE,
    [FAMECHECKER_SABRINA]  = FEMININE,
    [FAMECHECKER_BLAINE]   = MASCULINE,
    [FAMECHECKER_LORELEI]  = FEMININE,
    [FAMECHECKER_BRUNO]    = MASCULINE,
    [FAMECHECKER_AGATHA]   = FEMININE,
    [FAMECHECKER_LANCE]    = MASCULINE,
    [FAMECHECKER_BILL]     = MASCULINE,
    [FAMECHECKER_MRFUJI]   = MASCULINE,
    [FAMECHECKER_GIOVANNI] = MASCULINE,
};
