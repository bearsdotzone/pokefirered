...
const u8 gText_Masc[] = _("MASC");
const u8 gText_Femme[] = _("FEMME");
const u8 gText_HeHim[] = _("HE/HIM");
const u8 gText_SheHer[] = _("SHE/HER");
...
const u8 gText_ExpAllDisabled[] = _("The Exp. All has been disabled.");
const u8 gText_ExpAllEnabled[] = _("The Exp. All has been enabled.");
...
const u8 gText_RunMode[] = _("RUN MODE");
const u8 gText_RunModeAlways[] = _("ALWAYS");
const u8 gText_RunModeToggle[] = _("TOGGLE");
const u8 gText_RunModeHold[] = _("HOLD");
