...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    {OBJ_EVENT_GFX_WOMAN_2,        FACILITY_CLASS_RS_AROMA_LADY,     FEMININE},
    {OBJ_EVENT_GFX_HIKER,          FACILITY_CLASS_RS_RUIN_MANIAC,      MASCULINE},
    {OBJ_EVENT_GFX_TUBER_F,        FACILITY_CLASS_RS_TUBER_F,        FEMININE},
    {OBJ_EVENT_GFX_TUBER_M_LAND,   FACILITY_CLASS_RS_TUBER_M,          MASCULINE},
    {OBJ_EVENT_GFX_COOLTRAINER_M,  FACILITY_CLASS_RS_COOLTRAINER_M,    MASCULINE},
    {OBJ_EVENT_GFX_COOLTRAINER_F,  FACILITY_CLASS_RS_COOLTRAINER_F,  FEMININE},
    {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_HEX_MANIAC,          MASCULINE},
    {OBJ_EVENT_GFX_WOMAN_2,        FACILITY_CLASS_RS_LADY,           FEMININE},
    {OBJ_EVENT_GFX_BEAUTY,         FACILITY_CLASS_RS_BEAUTY,         FEMININE},
    {OBJ_EVENT_GFX_BOY,            FACILITY_CLASS_RICH_BOY,            MASCULINE},
    {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_RS_POKEMANIAC,       MASCULINE},
    {OBJ_EVENT_GFX_SWIMMER_M_LAND, FACILITY_CLASS_RS_SWIMMER_M,        MASCULINE},
    {OBJ_EVENT_GFX_BLACKBELT,      FACILITY_CLASS_RS_BLACK_BELT,       MASCULINE},
    {OBJ_EVENT_GFX_ROCKER,         FACILITY_CLASS_GUITARIST,           MASCULINE},
    {OBJ_EVENT_GFX_ROCKER,         FACILITY_CLASS_KINDLER,             MASCULINE},
    {OBJ_EVENT_GFX_CAMPER,         FACILITY_CLASS_RS_CAMPER,           MASCULINE},
    {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_BUG_MANIAC,          MASCULINE},
    {OBJ_EVENT_GFX_BOY,            FACILITY_CLASS_RS_PSYCHIC_M,        MASCULINE},
    {OBJ_EVENT_GFX_WOMAN_1,        FACILITY_CLASS_RS_PSYCHIC_F,      FEMININE},
    {OBJ_EVENT_GFX_GENTLEMAN,      FACILITY_CLASS_RS_GENTLEMAN,        MASCULINE},
    {OBJ_EVENT_GFX_BOY,            FACILITY_CLASS_SCHOOL_KID_M,        MASCULINE},
    {OBJ_EVENT_GFX_WOMAN_1,        FACILITY_CLASS_SCHOOL_KID_F,      FEMININE},
    {OBJ_EVENT_GFX_BALDING_MAN,    FACILITY_CLASS_POKEFAN_M,           MASCULINE},
    {OBJ_EVENT_GFX_WOMAN_3,        FACILITY_CLASS_POKEFAN_F,         FEMININE},
    {OBJ_EVENT_GFX_OLD_MAN_1,      FACILITY_CLASS_EXPERT_M,            MASCULINE},
    {OBJ_EVENT_GFX_OLD_WOMAN,      FACILITY_CLASS_EXPERT_F,          FEMININE},
    {OBJ_EVENT_GFX_YOUNGSTER,      FACILITY_CLASS_RS_YOUNGSTER,        MASCULINE},
    {OBJ_EVENT_GFX_FISHER,         FACILITY_CLASS_RS_FISHERMAN,        MASCULINE},
    {OBJ_EVENT_GFX_COOLTRAINER_M,  FACILITY_CLASS_DRAGON_TAMER,        MASCULINE},
    {OBJ_EVENT_GFX_ROCKER,         FACILITY_CLASS_RS_BIRD_KEEPER,      MASCULINE},
    {OBJ_EVENT_GFX_LITTLE_BOY,     FACILITY_CLASS_NINJA_BOY,           MASCULINE},
    {OBJ_EVENT_GFX_BATTLE_GIRL,    FACILITY_CLASS_BATTLE_GIRL,       FEMININE},
    {OBJ_EVENT_GFX_BEAUTY,         FACILITY_CLASS_PARASOL_LADY,      FEMININE},
    {OBJ_EVENT_GFX_SWIMMER_F_LAND, FACILITY_CLASS_RS_SWIMMER_F,      FEMININE},
    {OBJ_EVENT_GFX_PICNICKER,      FACILITY_CLASS_RS_PICNICKER,      FEMININE},
    {OBJ_EVENT_GFX_SAILOR,         FACILITY_CLASS_RS_SAILOR,           MASCULINE},
    {OBJ_EVENT_GFX_FAT_MAN,        FACILITY_CLASS_COLLECTOR,           MASCULINE},
    {OBJ_EVENT_GFX_MAN,            FACILITY_CLASS_RS_PKMN_BREEDER_M,   MASCULINE},
    {OBJ_EVENT_GFX_WOMAN_2,        FACILITY_CLASS_RS_PKMN_BREEDER_F, FEMININE},
    {OBJ_EVENT_GFX_CAMPER,         FACILITY_CLASS_RS_PKMN_RANGER_M,    MASCULINE},
    {OBJ_EVENT_GFX_PICNICKER,      FACILITY_CLASS_RS_PKMN_RANGER_F,  FEMININE},
    {OBJ_EVENT_GFX_LASS,           FACILITY_CLASS_RS_LASS,           FEMININE},
    {OBJ_EVENT_GFX_BUG_CATCHER,    FACILITY_CLASS_RS_BUG_CATCHER,      MASCULINE},
    {OBJ_EVENT_GFX_HIKER,          FACILITY_CLASS_RS_HIKER,            MASCULINE},
    {OBJ_EVENT_GFX_YOUNGSTER,      FACILITY_CLASS_YOUNGSTER,           MASCULINE},
    {OBJ_EVENT_GFX_BUG_CATCHER,    FACILITY_CLASS_BUG_CATCHER,         MASCULINE},
    {OBJ_EVENT_GFX_LASS,           FACILITY_CLASS_LASS,              FEMININE},
    {OBJ_EVENT_GFX_SAILOR,         FACILITY_CLASS_SAILOR,              MASCULINE},
    {OBJ_EVENT_GFX_CAMPER,         FACILITY_CLASS_CAMPER,              MASCULINE},
    {OBJ_EVENT_GFX_PICNICKER,      FACILITY_CLASS_PICNICKER,         FEMININE},
    {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_POKEMANIAC,          MASCULINE},
    {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_SUPER_NERD,          MASCULINE},
    {OBJ_EVENT_GFX_HIKER,          FACILITY_CLASS_HIKER,               MASCULINE},
    {OBJ_EVENT_GFX_BIKER,          FACILITY_CLASS_BIKER,               MASCULINE},
    {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_BURGLAR,             MASCULINE},
    {OBJ_EVENT_GFX_BALDING_MAN,    FACILITY_CLASS_ENGINEER,            MASCULINE},
    {OBJ_EVENT_GFX_FISHER,         FACILITY_CLASS_FISHERMAN,           MASCULINE},
    {OBJ_EVENT_GFX_SWIMMER_M_LAND, FACILITY_CLASS_SWIMMER_M,           MASCULINE},
    {OBJ_EVENT_GFX_BIKER,          FACILITY_CLASS_CUE_BALL,            MASCULINE},
    {OBJ_EVENT_GFX_OLD_MAN_1,      FACILITY_CLASS_GAMER,               MASCULINE},
    {OBJ_EVENT_GFX_BEAUTY,         FACILITY_CLASS_BEAUTY,            FEMININE},
    {OBJ_EVENT_GFX_SWIMMER_F_LAND, FACILITY_CLASS_SWIMMER_F,         FEMININE},
    {OBJ_EVENT_GFX_BOY,            FACILITY_CLASS_PSYCHIC_M,           MASCULINE},
    {OBJ_EVENT_GFX_ROCKER,         FACILITY_CLASS_ROCKER,              MASCULINE},
    {OBJ_EVENT_GFX_ROCKER,         FACILITY_CLASS_JUGGLER,             MASCULINE},
    {OBJ_EVENT_GFX_MAN,            FACILITY_CLASS_TAMER,               MASCULINE},
    {OBJ_EVENT_GFX_ROCKER,         FACILITY_CLASS_BIRD_KEEPER,         MASCULINE},
    {OBJ_EVENT_GFX_BLACKBELT,      FACILITY_CLASS_BLACK_BELT,          MASCULINE},
    {OBJ_EVENT_GFX_SCIENTIST,      FACILITY_CLASS_SCIENTIST,           MASCULINE},
    {OBJ_EVENT_GFX_COOLTRAINER_M,  FACILITY_CLASS_COOLTRAINER_M,       MASCULINE},
    {OBJ_EVENT_GFX_COOLTRAINER_F,  FACILITY_CLASS_COOLTRAINER_F,     FEMININE},
    {OBJ_EVENT_GFX_GENTLEMAN,      FACILITY_CLASS_GENTLEMAN,           MASCULINE},
    {OBJ_EVENT_GFX_CHANNELER,      FACILITY_CLASS_CHANNELER,         FEMININE},
    {OBJ_EVENT_GFX_WOMAN_1,        FACILITY_CLASS_PSYCHIC_F,         FEMININE},
    {OBJ_EVENT_GFX_BATTLE_GIRL,    FACILITY_CLASS_CRUSH_GIRL,        FEMININE},
    {OBJ_EVENT_GFX_TUBER_F,        FACILITY_CLASS_TUBER,             FEMININE},
    {OBJ_EVENT_GFX_WOMAN_2,        FACILITY_CLASS_PKMN_BREEDER,      FEMININE},
    {OBJ_EVENT_GFX_CAMPER,         FACILITY_CLASS_PKMN_RANGER_M,       MASCULINE},
    {OBJ_EVENT_GFX_PICNICKER,      FACILITY_CLASS_PKMN_RANGER_F,     FEMININE},
    {OBJ_EVENT_GFX_WOMAN_2,        FACILITY_CLASS_AROMA_LADY,        FEMININE},
    {OBJ_EVENT_GFX_HIKER,          FACILITY_CLASS_RUIN_MANIAC,         MASCULINE},
    {OBJ_EVENT_GFX_WOMAN_2,        FACILITY_CLASS_LADY,              FEMININE},
    {OBJ_EVENT_GFX_LASS,           FACILITY_CLASS_PAINTER,           FEMININE}
};

static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    {OBJ_EVENT_GFX_BEAUTY,         OBJ_EVENT_GFX_WOMAN_1,        FACILITY_CLASS_SR_AND_JR,       FEMININE, FEMININE},
    {OBJ_EVENT_GFX_LITTLE_GIRL,    OBJ_EVENT_GFX_LITTLE_GIRL,    FACILITY_CLASS_RS_TWINS,        FEMININE, FEMININE},
    {OBJ_EVENT_GFX_BEAUTY,         OBJ_EVENT_GFX_MAN,            FACILITY_CLASS_RS_YOUNG_COUPLE, FEMININE,   MASCULINE},
    {OBJ_EVENT_GFX_OLD_MAN_1,      OBJ_EVENT_GFX_OLD_WOMAN,      FACILITY_CLASS_OLD_COUPLE,        MASCULINE, FEMININE},
    {OBJ_EVENT_GFX_TUBER_M_LAND,   OBJ_EVENT_GFX_SWIMMER_F_LAND, FACILITY_CLASS_RS_SIS_AND_BRO,    MASCULINE, FEMININE},
    {OBJ_EVENT_GFX_LITTLE_GIRL,    OBJ_EVENT_GFX_LITTLE_GIRL,    FACILITY_CLASS_TWINS,           FEMININE, FEMININE},
    {OBJ_EVENT_GFX_COOLTRAINER_M,  OBJ_EVENT_GFX_COOLTRAINER_F,  FACILITY_CLASS_COOL_COUPLE,       MASCULINE, FEMININE},
    {OBJ_EVENT_GFX_BEAUTY,         OBJ_EVENT_GFX_MAN,            FACILITY_CLASS_YOUNG_COUPLE,    FEMININE,   MASCULINE},
    {OBJ_EVENT_GFX_BATTLE_GIRL,    OBJ_EVENT_GFX_BLACKBELT,      FACILITY_CLASS_CRUSH_KIN,       FEMININE,   MASCULINE},
    {OBJ_EVENT_GFX_SWIMMER_F_LAND, OBJ_EVENT_GFX_TUBER_M_LAND,   FACILITY_CLASS_SIS_AND_BRO,     FEMININE,   MASCULINE}
};
